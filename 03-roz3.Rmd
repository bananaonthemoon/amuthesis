...
kable(head(dane_woj3[c(1,2, 16, 17, 18, 21, 22, 23)], 5), align = 'c', format.args = list(scientific = FALSE), booktabs = TRUE, col.names = c('TERYT','JPT_KOD_JE', 't1_frek',	't2_frek',	't1_duda', 't2_trzaskowski',	't2_roznica_glosow',	'roznica_frek'), caption = "Fragment wyczyszczonych danych wyborczych z II tury Źródło: wybory.gov.pl",) %>%
kable_styling("hover", full_width = F, latex_options = "scale_down") %>%
row_spec(1, extra_css = "vertical- align:middle !important;") %>%
kableExtra::column_spec(1, width = "1cm") %>%
kableExtra::column_spec(2, width = "4cm") %>%
...
kable(head(dane_woj3[c(1,2, 16:23)], 5), align = 'c', format.args = list(scientific = FALSE), booktabs = TRUE, col.names = c('TERYT','JPT_KOD_JE', 't1_frek',	't2_frek',	't1_duda',	't1_trzaskowski',	't2_duda',	't2_trzaskowski',	't2_roznica_glosow',	'roznica_frek'), caption = "Fragment wyczyszczonych danych wyborczych z II tury Źródło: wybory.gov.pl",) %>%
kable_styling("hover", full_width = F, latex_options = "scale_down") %>%
row_spec(1, extra_css = "vertical- align:middle !important;") %>%
kableExtra::column_spec(1, width = "1cm") %>%
kableExtra::column_spec(2, width = "4cm") %>%
